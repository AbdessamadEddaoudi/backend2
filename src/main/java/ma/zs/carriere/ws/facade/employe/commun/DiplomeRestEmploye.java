package  ma.zs.carriere.ws.facade.employe.commun;
...
@RestController
@RequestMapping("/api/employe/diplome/")
public class DiplomeRestEmploye {
    ...
    @Autowired private DiplomeEmployeService service;
