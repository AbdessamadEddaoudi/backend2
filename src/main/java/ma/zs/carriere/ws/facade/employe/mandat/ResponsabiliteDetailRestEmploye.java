...
@RestController
@RequestMapping("/api/employe/responsabiliteDetail/")
public class ResponsabiliteDetailRestEmploye {
    ...
    @Autowired private ResponsabiliteDetailEmployeService service;
