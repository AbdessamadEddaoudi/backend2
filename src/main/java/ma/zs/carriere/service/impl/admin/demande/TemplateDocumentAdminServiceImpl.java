...
import ma.zs.carriere.service.facade.admin.demande.TypeDocumentAdminService ;
import ma.zs.carriere.bean.core.demande.TypeDocument ;

import java.util.List;
@Service
public class TemplateDocumentAdminServiceImpl implements TemplateDocumentAdminService {
    ...
    @Autowired
    private TypeDocumentAdminService typeDocumentService ;
