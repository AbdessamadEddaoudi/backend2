function fn() {
    ...
    config.etatDemandeDocumentUrl = config.adminUri + 'etatDemandeDocument/';
    config.templateDocumentUrl = config.adminUri + 'templateDocument/';
    config.demandeDocumentUrl = config.adminUri + 'demandeDocument/';
    config.typeDocumentUrl = config.adminUri + 'typeDocument/';
    config.responsabiliteDetailUrl = config.adminUri + 'responsabiliteDetail/';
